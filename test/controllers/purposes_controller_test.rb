...
class PurposesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purpose" do
    assert_difference("Purpose.count") do
      post purposes_url, params: { purpose: { booking_id: @purpose.booking_id, customer_id: @purpose.customer_id, their_purpose: @purpose.their_purpose } }
    end
  ...
  test "should update purpose" do
    patch purpose_url(@purpose), params: { purpose: { booking_id: @purpose.booking_id, customer_id: @purpose.customer_id, their_purpose: @purpose.their_purpose } }
