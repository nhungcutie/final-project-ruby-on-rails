...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference("Area.count") do
      post areas_url, params: { area: { description: @area.description, place_code: @area.place_code } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { description: @area.description, place_code: @area.place_code } }
